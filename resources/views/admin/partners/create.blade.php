            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control @error('logo') is-invalid @enderror" id="logo" name="logo" value="{{ old('logo') }}" readonly required>
                    ...
                    <div class="mt-2">
                        <img id="logo_preview" src="" alt="" class="img-thumbnail" style="max-height: 100px; display: none;">
                    </div>
                </div>
